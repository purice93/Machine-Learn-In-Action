...
import unit09.regTrees as regTrees
...
def reDraw(tolS, tolN):
    ...
    if chkBtnVar.get():
        if tolN < 2: tolN = 2
        myTree = regTrees.create_tree(reDraw.rawDat, regTrees.modelLeaf, regTrees.modelErr, (tolS, tolN))
        yHat = regTrees.createForeCast(myTree, reDraw.testDat, regTrees.modelTreeEval)
    else:
        myTree = regTrees.create_tree(reDraw.rawDat, options=(tolS, tolN))
